...
X, y = make_classification(
    n_samples=50000, #500 mil registros
    n_features=10,      #10 varaibles predictoras
    n_informative=6,    #6 relevantes para la predicción
    n_redundant=2,       #2 redundantes
    n_classes=2,         #Moroso o no
    weights=[0.7, 0.3],  #70% no moroso, 30% morosos
    random_state=42
)
...
print(f"Dataset sintetico generado con éxito en: \n{output_path}")